    ...
    return (
        <div className="banner-container">
            ...
            <div className="container-column">
                <p className="banner-heading"><Typewriter text="FINDING THE RIGHT SOLUTION FOR YOUR BUSINESS IN SUPPLY CHAIN ANALYSIS, TRANSPORT MONITORING, DEMAND FORECASTING" delay={1000} /></p>
